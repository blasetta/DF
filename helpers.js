        ...
        if (isArray) {
           ...
           // intestazione per Actions on google
               /*Todo oggetto simpleresponse in google assistant, massimo DUE occorrenze. */
                ...
                var AogCarousel = {"carouselBrowse": { "items": [] } };
            ...
            responses.forEach( robj => {
                ...
                var carouselObj = JSON.parse( JSON.stringify(jTemplates.get("carouselItem")));
                ...
                AogCarousel.carouselBrowse.items.push(carouselObj);
            ...
            myresp.data.google.richResponse.items.push(AogCarousel);
